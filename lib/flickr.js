...
flickr.prototype.api = function(apiMethod, urlParams, accessToken, next){
  ...
  request.queryParams.oauth_signature = buildSignature(request, this.settings.oauth_consumer_secret, accessToken.oauth_token_secret);
