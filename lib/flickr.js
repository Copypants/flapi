...
flickr.prototype.getUserAccessToken = function(oauth_verifier, next){
  ...
  request.queryParams.oauth_signature = buildSignature(this.settings, request, this.settings.oauth_token_secret);
  request.queryParams = addDefaultParams(this.settings, request.queryParams);
...
// at least i think so
var buildSignature = function(settings, opts, secret){
  ...
  var encodeKey = settings.consumerSecret + '&' + secret;
