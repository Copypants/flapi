...
flickr.prototype.authApp = function(authCallbackURL, next){
  ...
  if(!this.settings.oauth_consumer_key)     throw new Error('An oauth_consumer_key (app key) is required. ' + message);
  if(!this.settings.oauth_consumer_secret)  throw new Error('An oauth_consumer_secret (app secret) is required. ' + message);
...
flickr.prototype.getUserAccessToken = function(oauth_verifier, next){
  ...
  request.queryParams.oauth_signature = buildSignature(request, this.settings.oauth_consumer_secret, this.settings.oauth_token_secret);
...
flickr.prototype.api = function(opts){
  ...
  request.queryParams.oauth_signature = buildSignature(request, this.settings.oauth_consumer_secret, opts.accessToken.oauth_token_secret);
